...
##
# (3)  Verschaffe dir ein Überblick Über die Daten (str(), names())
unique(shp14$p15n35)
unique(shp14$p15n38)
unique(shp14$p15n34)
unique(shp14$age15)
unique(shp14$sex15)
unique(shp14$nbadul15)
unique(shp14$p15d29)
unique(shp14$p15p10)
unique(shp14$p15w34a)
unique(shp14$isced15)
unique(shp14$wstat15)
unique(shp14$x15i04)
unique(shp14$i15wyg)
unique(shp14$p15w32)
unique(shp14$ownkid15)
unique(shp14$canton15)
unique(shp14$nat_1_15)
unique(shp14$nbkid15)
unique(shp14$p15d160)
unique(shp14$region15)
unique(shp14$p15r02)


shp14%>%group_by(p15n35)%>%summarize(n())
